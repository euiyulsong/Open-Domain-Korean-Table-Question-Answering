...
if __name__ == "__main__":
    ...
    few_shot = [
        {"pos": ["급수공사 연간단가계약 일반․특별 시방서\n{\"연번\": \"6\", \"장비 및 공구명\": \"작업차량\", \"규격\": \"1.0톤이상\", \"수량\": \"1대이상\"}"], "query": "급수공사 연간단가계약 일반․특별 시방서에서 작업차량의 규격은 얼마니?", "question": "급수공사 연간단가계약 일반․특별 시방서에서 작업차량의 규격은 얼마니?", "answer": "1.0톤 이상", "neg": [], "chosen": "1.0톤 이상", "refined_q": "급수공사 연간단가계약 일반․특별 시방서에서 작업차량의 규격은 얼마니?", "refined_a": "1.0톤이상"},
        ...
        {"pos": ["- 김천대학교 덕곡동 근린생활시설 신축공사 건축감리용역 -과업이행요청서\n{\"제출건명\": \"수시보고\", \"제출 시기\": \"◦감독관지시가 있을 경우 즉시 보고\", \"첨부물\": \"◦감독관 요구 서류\", \"제출 부수\": \"2부\"}"],
         "query": "수시보고는 어떤 시기에 제출해야 해?", "question": "수시보고는 어떤 시기에 제출해야 해?", "answer": "감독관 지시가 있을 경우 즉시 보고", "neg": [], "chosen": "감독관 지시가 있을 경우 즉시 보고", "refined_a": "◦감독관지시가 있을 경우 즉시 보고", "refined_q": "김천대학교 덕곡동 근린생활시설 신축공사 건축감리용역 과업이행요청서에서 수시보고는 어떤 시기에 제출해야 해?"},
